...
class ApiTaxType extends AbstractStructBase
{
     ...
     * The Code
     * Meta informations extracted from the WSDL
     * - documentation: Used for codes in the OpenTravel Code tables. Possible values of this pattern are 1, 101, 101.EQP, or 101.EQP.X. | Used for codes in the OpenTravel Code tables. Possible values of this pattern are 1, 101, 101.EQP, or 101.EQP.X.
     ...
     * The Percent
     * Meta informations extracted from the WSDL
     * - documentation: Used for percentage values. | Used for percentage values.
     * - maxInclusive: 100.00
     * - minInclusive: 0.00
     * @var float
     */
     ...
     * The Amount
     * Meta informations extracted from the WSDL
     * - documentation: Specifies an amount, max 3 decimals. | Specifies an amount, max 3 decimals.
     * - fractionDigits: 3
     * @var float
     */
    public $Amount;
     ...
     * The CurrencyCode
     * Meta informations extracted from the WSDL
     * - documentation: Used for an Alpha String, length exactly 3. | Used for an Alpha String, length exactly 3.
     * - pattern: [a-zA-Z]{3}
     * @var string
     */
    public $CurrencyCode;
