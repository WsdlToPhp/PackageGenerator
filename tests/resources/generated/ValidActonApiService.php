...
class ApiService extends AbstractSoapClientBase
{
    ...
    {
        try {
            $this->setResult(self::getSoapClient()->__soapCall('login', array(
                $parameter,
    ...
    {
        try {
            $this->setResult(self::getSoapClient()->__soapCall('sendEmail', array(
                $parameter,
            ), array(), array(), $this->outputHeaders));
            return $this->getResult();
        } catch (\SoapFault $soapFault) {
    ...
    {
        try {
            $this->setResult(self::getSoapClient()->__soapCall('list', array(
                $parameter,
            ), array(), array(), $this->outputHeaders));
            return $this->getResult();
        } catch (\SoapFault $soapFault) {
    ...
    {
        try {
            $this->setResult(self::getSoapClient()->__soapCall('uploadList', array(
                $parameter,
            ), array(), array(), $this->outputHeaders));
            return $this->getResult();
        } catch (\SoapFault $soapFault) {
    ...
    {
        try {
            $this->setResult(self::getSoapClient()->__soapCall('getUploadResult', array(
                $parameter,
            ), array(), array(), $this->outputHeaders));
            return $this->getResult();
        } catch (\SoapFault $soapFault) {
    ...
    {
        try {
            $this->setResult(self::getSoapClient()->__soapCall('downloadList', array(
                $parameter,
            ), array(), array(), $this->outputHeaders));
            return $this->getResult();
        } catch (\SoapFault $soapFault) {
    ...
    {
        try {
            $this->setResult(self::getSoapClient()->__soapCall('messageReport', array(
                $parameter,
            ), array(), array(), $this->outputHeaders));
            return $this->getResult();
        } catch (\SoapFault $soapFault) {
    ...
    {
        try {
            $this->setResult(self::getSoapClient()->__soapCall('deleteList', array(
                $parameter,
            ), array(), array(), $this->outputHeaders));
            return $this->getResult();
        } catch (\SoapFault $soapFault) {
