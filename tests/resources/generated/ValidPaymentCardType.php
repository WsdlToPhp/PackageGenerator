...
class ApiPaymentCardType extends AbstractStructBase
{
    ...
    public function setTelephone(array $telephone = array())
    {
        foreach ($telephone as $paymentCardTypeTelephoneItem) {
            ...
            if (!$paymentCardTypeTelephoneItem instanceof \Api\StructType\ApiTelephone) {
                throw new \InvalidArgumentException(sprintf('The Telephone property can only contain items of \Api\StructType\ApiTelephone, "%s" given', is_object($paymentCardTypeTelephoneItem) ? get_class($paymentCardTypeTelephoneItem) : gettype($paymentCardTypeTelephoneItem)), __LINE__);
            }
        }
    ...
    public function addToTelephone(\Api\StructType\ApiTelephone $item)
    {
        ...
        if (!$item instanceof \Api\StructType\ApiTelephone) {
            throw new \InvalidArgumentException(sprintf('The Telephone property can only contain items of \Api\StructType\ApiTelephone, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Telephone[] = $item;
        return $this;
    }
    ...
    public function setEmail(array $email = array())
    {
        foreach ($email as $paymentCardTypeEmailItem) {
            ...
            if (!$paymentCardTypeEmailItem instanceof \Api\StructType\ApiEmailType) {
                throw new \InvalidArgumentException(sprintf('The Email property can only contain items of \Api\StructType\ApiEmailType, "%s" given', is_object($paymentCardTypeEmailItem) ? get_class($paymentCardTypeEmailItem) : gettype($paymentCardTypeEmailItem)), __LINE__);
            }
        }
        $this->Email = $email;
        return $this;
    ...
    public function addToEmail(\Api\StructType\ApiEmailType $item)
    {
        ...
        if (!$item instanceof \Api\StructType\ApiEmailType) {
            throw new \InvalidArgumentException(sprintf('The Email property can only contain items of \Api\StructType\ApiEmailType, "%s" given', is_object($item) ? get_class($item) : gettype($item)), __LINE__);
        }
        $this->Email[] = $item;
        return $this;
    }
    ...
    public function setCardCode($cardCode = null)
    {
        ...
        if (!\Api\EnumType\ApiPaymentCardCodeType::valueIsValid($cardCode)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $cardCode, implode(', ', \Api\EnumType\ApiPaymentCardCodeType::getValidValues())), __LINE__);
        }
